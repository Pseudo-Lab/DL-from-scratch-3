...
| 2025/04/07 | 17단계 메모리 관리와 순환 참조 ~ 22단계 연산자 오버로드  | 김진영 | 
| 2025/04/14 | 23단계 패키지로 정리 ~ 26단계 계산 그래프 시각화  | 송윤호 | 
| 2025/04/21 | 27단계 테일러 급수 미분 ~ 32단계 고차 미분  | 박진경 | 
| 2025/04/28 | ⭐Magical Week⭐  | - | 
| 2025/05/05 | 어린이날  | - | 
| 2025/05/12 | 33단계 뉴턴 방법으로 푸는 최적화 ~ 36단계 고차 미분 이외의 용도  | 김도현 | 
| 2025/05/19 | 37단계 텐서를 다루다 ~ 40단계 브로드캐스트 함수  | 고지호 | 
| 2025/05/26 | 41단계 행렬의 곱 ~ 44단계 매개변수를 모아두는 계층  | 김솔 | 
| 2025/06/02 | 45단계 계층을 모아두는 계층 ~ 47단계 소프트맥스 함수와 교차 엔트로피 오차  | 정지윤 | 
